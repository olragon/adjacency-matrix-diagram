            ...
            <div id="editor-outer" class="row">
                <div id="editor" class="haft">
                    ...
                    <p class="description">
                        ...
                        - Your work will be auto saved in your local browser or you can download state file and load
                        later.<br>
                        - You want to read <a
                ...
                <div id="diagram" class="haft">
                    <svg :width="svgSize.width" :height="svgSize.height" id="svg-image">
                        <g v-for="(r, ri) in modelRooms" :key="'room-' + ri" :transform="r.g.transform"
                            class="room-wrap" :class="{ active: isActive({ r, ri }) }">
                        ...
                        <g
                            :transform="`translate(${length * baseLengthUnit + rooms.length * baseLengthUnit + 3 * baseLengthUnit}, 0)`">
